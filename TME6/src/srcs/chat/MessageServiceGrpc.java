...
/**
 * <pre>
 * service côté client pour faire parvenir le message au client
 * </pre>
 */
...
public final class MessageServiceGrpc {
  ...
  public static final String SERVICE_NAME = "srcs.chat.MessageService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<srcs.chat.ChatMessage,
      srcs.chat.Empty> getNewMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "newMessage",
      requestType = srcs.chat.ChatMessage.class,
      responseType = srcs.chat.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<srcs.chat.ChatMessage,
      srcs.chat.Empty> getNewMessageMethod() {
    io.grpc.MethodDescriptor<srcs.chat.ChatMessage, srcs.chat.Empty> getNewMessageMethod;
    if ((getNewMessageMethod = MessageServiceGrpc.getNewMessageMethod) == null) {
      synchronized (MessageServiceGrpc.class) {
        if ((getNewMessageMethod = MessageServiceGrpc.getNewMessageMethod) == null) {
          MessageServiceGrpc.getNewMessageMethod = getNewMessageMethod =
              io.grpc.MethodDescriptor.<srcs.chat.ChatMessage, srcs.chat.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "newMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  srcs.chat.ChatMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  srcs.chat.Empty.getDefaultInstance()))
              .setSchemaDescriptor(new MessageServiceMethodDescriptorSupplier("newMessage"))
              .build();
        }
      }
    }
  ...
  public static abstract class MessageServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void newMessage(srcs.chat.ChatMessage request,
        io.grpc.stub.StreamObserver<srcs.chat.Empty> responseObserver) {
      asyncUnimplementedUnaryCall(getNewMessageMethod(), responseObserver);
    }
  ...
  public static final class MessageServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MessageServiceBlockingStub> {
    ...
    /**
     */
    public srcs.chat.Empty newMessage(srcs.chat.ChatMessage request) {
  ...
  public static final class MessageServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MessageServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<srcs.chat.Empty> newMessage(
        srcs.chat.ChatMessage request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_NEW_MESSAGE:
          serviceImpl.newMessage((srcs.chat.ChatMessage) request,
              (io.grpc.stub.StreamObserver<srcs.chat.Empty>) responseObserver);
          break;
        default:
