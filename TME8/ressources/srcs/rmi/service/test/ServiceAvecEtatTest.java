...
public class ServiceAvecEtatTest extends SystemDeployer {
	...
	public void test() throws RemoteException, NotBoundException {
		...
		FunctionService<Operation,Integer> cpt1 = (FunctionService<Operation, Integer>) s1.deployNewService(nameservice, Compteur.class );
		...
		assertThrows(NoSuchObjectException.class, ()->cpt1.invoke(get));
	}
